...
@section('body')
    ...
    <billing-my-article-listing
        :data="{{ $data->toJson() }}"
        :url="'{{ url('admin/billing-my-articles') }}'"
        inline-template>
            ...
            <div class="col">
                <div class="card">
                    <div class="card-header">
                        ...
                        <a class="btn btn-primary btn-spinner btn-sm pull-right m-b-0" href="{{ url('admin/billing-my-articles/create') }}" role="button"><i class="fa fa-plus"></i>&nbsp; {{ trans('admin.billing_my-article.actions.create') }}</a>
                    </div>
                    <div class="card-body" v-cloak>
                        <div class="card-block">
                            ...
                            <div class="no-items-found" v-if="!collection.length > 0">
                                ...
                                <a class="btn btn-primary btn-spinner" href="{{ url('admin/billing-my-articles/create') }}" role="button"><i class="fa fa-plus"></i>&nbsp; {{ trans('admin.billing_my-article.actions.create') }}</a>
                            </div>
                        </div>
                    </div>
                </div>
