        ...
        <categ-ory-form
            ...
            :translations="{{ json_encode([
                ...
                'columns' => [
                    ...
                    'name' => trans('admin.categ-ory.columns.name'),
                    'first_name' => trans('admin.categ-ory.columns.first_name'),
                    'last_name' => trans('admin.categ-ory.columns.last_name'),
                    'subject' => trans('admin.categ-ory.columns.subject'),
                    'email' => trans('admin.categ-ory.columns.email'),
                    'password' => trans('admin.categ-ory.columns.password'),
                    'password_repeat' => trans('admin.categ-ory.columns.password_repeat'),
                    ...
                    'released_at' => trans('admin.categ-ory.columns.released_at'),
                    ...
                    'rating' => trans('admin.categ-ory.columns.rating'),
                    'views' => trans('admin.categ-ory.columns.views'),
                ],
                'relations' => [
                    'posts' => trans('admin.categ-ory.relations.posts'),
                ],
