...
@section('title', trans('admin.feed_article.actions.index'))

@section('body')

    <feed-article-listing
        :data="{{ $data->toJson() }}"
        :url="'{{ $url }}'"
        ...
        :translations="{{ json_encode([
            'listing_title' => trans('admin.feed_article.actions.index'),
            'create_btn' => trans('admin.feed_article.actions.create'),
            'columns' => [
                'id' => trans('admin.feed_article.columns.id'),
