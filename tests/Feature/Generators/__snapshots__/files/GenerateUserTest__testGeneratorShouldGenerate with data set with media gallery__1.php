    ...
    public function create(): View
    {
        ...
        return $this->viewFactory->make(
            ...
            [
                ...
                'galleryCollection' => $userModel->getCustomMediaCollection('gallery'),
            ],
        );
    }
    ...
    public function edit(User $user): View
    {
        ...
        return $this->viewFactory->make(
            ...
            [
                ...
                'roles' => Role::where('guard_name', $this->guard)->get(),
                'galleryCollection' => $user->getCustomMediaCollection('gallery'),
                'galleryMedia' => $user->getThumbs200ForCollection('gallery'),
            ],
        );
    }
