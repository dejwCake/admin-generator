...
@section('title', trans('admin.auth_user.actions.edit', ['name' => $user->first_name]))
    ...
    <div class="container-xl">
        ...
        <auth-user-form
            ...
            :translations="{{ json_encode([
                'form_title' => trans('admin.auth_user.actions.edit', ['name' => $user->first_name . ' ' . $user->last_name]),
                'columns' => [
