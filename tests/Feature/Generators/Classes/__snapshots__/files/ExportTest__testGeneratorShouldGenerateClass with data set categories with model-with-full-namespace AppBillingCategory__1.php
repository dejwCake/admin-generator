...
final class CategoriesExport implements FromCollection, WithMapping, WithHeadings
{
    ...
    public function map($category): array
    {
        return [
            ...
            is_array($category->text) ? implode(', ', $category->text) : $category->text,
            is_array($category->description) ? implode(', ', $category->description) : $category->description,
            $category->enabled === null ? '' : ($category->enabled ? __('Yes') : __('No')),
            $category->send === null ? '' : ($category->send ? __('Yes') : __('No')),
            $category->price,
            $category->rating,
            $category->views,
