    ...
    public function create(): View
    {
        ...
        return $this->viewFactory->make(
            ...
            [
                ...
                'posts' => Post::all(),
                'users' => User::all(),
                'galleryCollection' => $categoryModel->getCustomMediaCollection('gallery'),
            ],
        );
    }
    ...
    public function edit(Category $category): View
    {
        ...
        return $this->viewFactory->make(
            ...
            [
                ...
                'posts' => Post::all(),
                'users' => User::all(),
                'galleryCollection' => $category->getCustomMediaCollection('gallery'),
                'galleryMedia' => $category->getThumbs200ForCollection('gallery'),
            ],
        );
    }
