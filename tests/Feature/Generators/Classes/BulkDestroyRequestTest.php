...
final class BulkDestroyRequestTest extends TestCase
{
    ...
    public function testGeneratorShouldGenerateClass(array $arguments, string $expectedFilePath): void
    {
        ...
        $this->artisan('admin:generate:request:bulk-destroy', $arguments);
    ...
    public function testGeneratorWithForceShouldOverwriteClass(): void
    {
        ...
        $this->artisan('admin:generate:request:bulk-destroy', ['table_name' => 'categories']);
        self::assertFileExists($filePath);
    ...
    public static function getCases(): iterable
    {
        yield 'categories default' => [
            ...
            'expectedFilePath' => 'app/Http/Requests/Admin/Category/BulkDestroyCategory.php',
        ];

        yield 'categories with model-name Billing\\Cat' => [
            'arguments' => ['table_name' => 'categories', '--model-name' => 'Billing\\Cat'],
            'expectedFilePath' => 'app/Http/Requests/Admin/Billing/Cat/BulkDestroyCat.php',
        ];

        yield 'categories with model-name App\\Billing\\Cat' => [
            'arguments' => ['table_name' => 'categories', '--model-name' => 'App\\Billing\\Cat'],
            'expectedFilePath' => 'app/Http/Requests/Admin/Cat/BulkDestroyCat.php',
        ];
        ...
        yield 'posts default' => [
            ...
            'expectedFilePath' => 'app/Http/Requests/Admin/Post/BulkDestroyPost.php',
        ];

        yield 'posts with model-name Feed\\Article' => [
            'arguments' => ['table_name' => 'posts', '--model-name' => 'Feed\\Article'],
            'expectedFilePath' => 'app/Http/Requests/Admin/Feed/Article/BulkDestroyArticle.php',
        ];

        yield 'posts with model-name App\\Feed\\Article' => [
            'arguments' => ['table_name' => 'posts', '--model-name' => 'App\\Feed\\Article'],
            'expectedFilePath' => 'app/Http/Requests/Admin/Article/BulkDestroyArticle.php',
        ];
