...
<div class="form-group row align-items-center" :class="{'has-danger': errors.has('activated'), 'has-success': fields.activated && fields.activated.valid }">
    <label for="activated" class="col-form-label text-md-right" :class="isFormLocalized ? 'col-md-4' : 'col-md-3'">{{ trans('admin.user.columns.activated') }}</label>
    <div :class="isFormLocalized ? 'col-md-4' : 'col-md-9 col-xl-7'">
        <input type="text" v-model="form.activated" v-validate="'required'" @input="validate($event)" class="form-control" :class="{'form-control-danger': errors.has('activated'), 'form-control-success': fields.activated && fields.activated.valid}" id="activated" name="activated" placeholder="{{ trans('admin.user.columns.activated') }}">
...
<div class="form-group row align-items-center" :class="{'has-danger': errors.has('forbidden'), 'has-success': fields.forbidden && fields.forbidden.valid }">
    <label for="forbidden" class="col-form-label text-md-right" :class="isFormLocalized ? 'col-md-4' : 'col-md-3'">{{ trans('admin.user.columns.forbidden') }}</label>
    <div :class="isFormLocalized ? 'col-md-4' : 'col-md-9 col-xl-7'">
        <input type="text" v-model="form.forbidden" v-validate="'required'" @input="validate($event)" class="form-control" :class="{'form-control-danger': errors.has('forbidden'), 'form-control-success': fields.forbidden && fields.forbidden.valid}" id="forbidden" name="forbidden" placeholder="{{ trans('admin.user.columns.forbidden') }}">
