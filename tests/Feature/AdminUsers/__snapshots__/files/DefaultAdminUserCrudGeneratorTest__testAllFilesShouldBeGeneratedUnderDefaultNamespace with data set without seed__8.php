            ...
            <div class="col">
                <div class="card">
                    <div class="card-header">
                        ...
                        <a class="btn btn-primary btn-sm pull-right m-b-0 ml-2" href="{{ url('admin/admin-users/export') }}" role="button"><i class="fa fa-file-excel-o"></i>&nbsp; {{ trans('admin.admin-user.actions.export') }}</a>
                        ...
                        <table class="table table-hover table-listing">
                            ...
                            <tbody>
                                <tr v-for="(item, index) in collection">
                                    ...
                                    <td >@{{ item.email }}</td>
                                    <td v-if="activation">@{{ item.activated }}</td>
                                    <td >
